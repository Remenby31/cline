 ...
 */
const MakeHubPerfRatioSlider: React.FC<MakeHubPerfRatioSliderProps> = ({ 
  apiConfiguration, 
  onChange 
}) => {
  // Use a default value of 0.5 if not set
  const value = apiConfiguration?.makehubPerfRatio !== undefined 
    ? apiConfiguration.makehubPerfRatio 
    : 0.5
